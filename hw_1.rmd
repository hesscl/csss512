...
\begin{description}
  ...
  \item[at 100] Now it looks more likely to be non-stationary, though ACF/PACF/dickey-fuller say stationary with _really_ strong AR(1) with 0.95 phi. The strong deviations from 0 (seemingly the mean) suggest that the time-series is non-stationary and likely an AR(1) process
